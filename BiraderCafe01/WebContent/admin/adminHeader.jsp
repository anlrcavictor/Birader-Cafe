...
<body id="page-top" class="index">
    ...
    <!-- Navigation -->
    <nav id="mainNav" class="backcolorblack navbar navbar-default navbar-fixed-top navbar-custom" style="background-color:black">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        <a href="/BiraderCafe01/haberController">Haberler</a>
                    </li>
                    <li class="page-scroll">
                        <a href="/BiraderCafe01/mesajController">Mesajlar</a>
                    </li>
                    <li class="page-scroll">
                        <a href="/BiraderCafe01/yoneticiController">Yonetici</a>
                    </li>
